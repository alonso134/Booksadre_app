...
/*
    const handleDeleteDetalleCarrito = async (idDetalle) => {
      try {
        ...
        const response = await fetch(`${ip}/T.Booksadre/api/services/public/pedido.php?action=deleteDetail`, {
          method: 'POST',
          body: formData
        });
...
const styles = StyleSheet.create({
  ...
  modifyButton: {
    ...
    paddingVertical: 8,
    paddingHorizontal: 16,
    backgroundColor: '#0dcaf0', // Light brown color for modify button
    marginVertical: 4,
  },
  deleteButton: {
    borderWidth: 1,
    ...
    paddingVertical: 8,
    paddingHorizontal: 16,
    backgroundColor: '#FF0000', // Darker orange color for delete button
    marginVertical: 4,
  },
  buttonText: {
    textAlign: 'center',
